...
`define USER_CONFIG_GPIO_5_INIT  `GPIO_MODE_MGMT_STD_BIDIRECTIONAL
`define USER_CONFIG_GPIO_6_INIT  `GPIO_MODE_MGMT_STD_BIDIRECTIONAL
`define USER_CONFIG_GPIO_7_INIT  `GPIO_MODE_MGMT_STD_BIDIRECTIONAL
